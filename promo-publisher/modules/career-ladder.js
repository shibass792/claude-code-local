...
function organicTools(engines, inventory) {
  ...
  return [
    ...
    },
    {
      ...
      ready: ffmpeg,
      tool: 'FFmpeg מקומי',
      how: 'Anyma: הווידאו הוא המוצר. ריל 1080×1920 מהטראק במחשב, בלי סטודיו חיצוני. אחרי סוכות — אותו צינור לקליפ קהל לא-ערוך.',
      next: ffmpeg ? 'רנדר מהנגן או גרור WAV' : 'התקן FFmpeg — בלי זה אין ריל מקומי',
    },
    {
      id: 'hooks',
      tab: 'create-tab',
