...
# ממשק Web — פאנל HTML עם ספריות נפרדות
music-brain serve
# → http://127.0.0.1:8787        פאנל ראשי
# → http://127.0.0.1:8787/music   כל השירים
# → http://127.0.0.1:8787/samples סמפלים לפי סוג (באס/קיק/...)
# → http://127.0.0.1:8787/loops  לופים
# → http://127.0.0.1:8787/search  חיפוש AI
...
- **`serve`** — UI בדפדפן: ספריות (מוזיקה/סמפלים/לופים), חיפוש, נגן, Cubase
- **`libraries`** — פירוט ספריות ותת-קטגוריות (באס, קיק, וכו')
- **`classify`** — סיווג מחדש של כל הקבצים לספריות
